...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView albums = (TextView) findViewById(R.id.main_Album_view);
        TextView artist = (TextView) findViewById(R.id.main_Artist_View);
        final TextView songs = (TextView) findViewById(R.id.main_Songs_View);
